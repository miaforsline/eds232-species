...
#remove duplicate observations with the same long/lat values 
...
In total, GBIF contains 1,205 observations of Necturus maculosus. 
...
Yes, I removed observations with the incorrect species name as well as one outlier located in Europe. I also removed 421 duplicate observations. 
